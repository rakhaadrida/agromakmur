...
@section('content')
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-2">
            <h1 class="h3 mb-0 text-gray-800 menu-title">Daftar Sales</h1>
            <div class="justify-content-end">
                <a href="{{ route('marketings.create') }}" class="btn btn-sm btn-primary shadow-sm">
                    <i class="fas fa-plus fa-sm text-white-50 mr-1"></i>  Tambah Sales Baru
                </a>
                <span class="vertical-hr mr-2 ml-1"></span>
                <a href="{{ route('marketings.deleted') }}" class="btn btn-sm btn-outline-danger shadow-sm">
                    <i class="fas fa-trash-alt fa-sm text-dark-50 mr-1"></i>  Sales yang Dihapus
                </a>
                <span class="vertical-hr mr-2 ml-1"></span>
                <a href="{{ route('marketings.export') }}" class="btn btn-sm btn-success shadow-sm">
