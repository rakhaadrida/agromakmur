                            ...
                            <form action="{{ route('report.product-histories.show', $product->id) }}" method="GET" id="form">
                                ...
                                <div class="container">
                                    <div class="row justify-content-center">
                                        <h4 class="text-bold text-dark">Histori {{ $product->name }} ({{ formatDateIso($startDate, 'DD MMM Y') }} - {{ formatDateIso($finalDate, 'D MMM Y') }}) </h4>
                                    </div>
                                ...
                                <table class="table table-sm table-bordered table-striped table-responsive-sm table-hover" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="12" class="text-center text-dark text-bold h4 p-2">Tidak Ada Data</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
