...
@section('content')
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-0">
            <h1 class="h3 mb-0 text-gray-800 menu-title">Sales Recap</h1>
        </div>
        @if ($errors->any())
        ...
        <div class="row">
            <div class="card-body">
                <ul class="nav nav-tabs" id="tabHeader" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link nav-link-inactive" id="customerTab" data-toggle="pill" data-target="#customer" type="button" role="tab" aria-controls="customer" aria-selected="false">By Customer</a>
                    </li>
                </ul>
                            ...
                            <div class="tab-content" id="tabContent">
                                    ...
                                    <form action="{{ route('report.sales-recap.index') }}" method="GET" id="form">
                                        ...
                                        <div class="container">
                                            <div class="row justify-content-center">
                                                <h4 class="text-bold text-dark">Sales Recap By Product ({{ formatDate($startDate, 'd M Y') }} - {{ formatDate($finalDate, 'd M Y') }}) </h4>
                                            </div>
                                ...
                                <div class="tab-pane fade" id="customer" role="tabpanel" aria-labelledby="customerTab">
                                    <form action="{{ route('report.sales-recap.index') }}" method="GET" id="form">
                                        ...
                                        <div class="container">
                                            <div class="row justify-content-center">
                                                <h4 class="text-bold text-dark">Sales Recap By Customer ({{ formatDate($startDate, 'd M Y') }} - {{ formatDate($finalDate, 'd M Y') }}) </h4>
                                            </div>
                                            <div class="row justify-content-center mb-2">
                                                <h6 class="text-dark">Report Time : {{ $reportDate }}</h6>
                                            </div>
