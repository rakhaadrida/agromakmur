...
@section('content')
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-2">
            <div>
                <h1 class="h3 mb-0 text-gray-800 menu-title">Daftar Gudang yang Dihapus</h1>
            </div>
            <div class="row">
                ...
                <a href="#" class="btn btn-sm btn-outline-danger shadow-sm mr-2 btn-delete" data-toggle="modal" data-target="#deleteWarehouseModal" data-id="0">
                    Hapus Permanen Semua Gudang
                </a>
                <a href="{{ route('warehouses.index') }}" class="btn btn-sm btn-outline-primary shadow-sm">Kembali ke Daftar Gudang</a>
            </div>
        </div>
        <div class="row">
            <div class="card-body">
