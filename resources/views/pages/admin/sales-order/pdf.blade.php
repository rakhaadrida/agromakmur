    ...
    <body>
        <div class="pdf-section">
            <div class="header-section text-center">
                <h5 class="text-bold text-dark">Daftar Sales Order</h5>
            ...
            <table class="table table-sm table-bordered table-items">
                <thead class="text-center text-dark text-bold" >
                    <tr>
                        ...
                        <th class="align-middle td-order-number">Nomor</th>
                        <th class="align-middle td-order-date">Tanggal</th>
                        <th class="align-middle td-branch">Cabang</th>
                        <th class="align-middle">Customer</th>
                        <th class="align-middle td-marketing">Sales</th>
                ...
                <tbody>
                    @foreach($salesOrders as $index => $salesOrder)
                        <tr class="text-dark">
                            ...
                            <td class="align-middle text-center">{{ formatDateIso($salesOrder->date, 'DD-MMM-YY')  }}</td>
