                ...
                return `
                    <tr class="text-bold text-dark" id="${rowId}">
                        ...
                        <td tabindex="0" data-row="${rowId}" data-col="6">
                            <input type="text" class="form-control form-control-sm text-bold text-dark text-right readonly-input" name="quantity[]" id="quantity-${rowId}" value="${thousandSeparator(item.remaining_quantity)}" data-toogle="tooltip" data-placement="bottom" title="Hanya masukkan angka saja" required>
