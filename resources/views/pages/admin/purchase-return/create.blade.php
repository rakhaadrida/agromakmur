...
@section('content')
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-0">
            <h1 class="h3 mb-0 text-gray-800 menu-title">Tambah Retur Pembelian</h1>
        </div>
        @if ($errors->any())
                            ...
                            <form action="{{ route('purchase-returns.store') }}" method="POST" id="form">
                                ...
                                <div class="container">
                                    ...
                                    <div class="form-group row delivery-order-customer-input">
                                        <label for="goodsReceiptId" class="col-2 col-form-label text-bold text-right">Nomor BM</label>
                                        <span class="col-form-label text-bold">:</span>
                                        <div class="col-2 mt-1">
                                            <select class="selectpicker warehouse-select-picker" name="goods_receipt_id" id="goodsReceiptId" data-live-search="true" data-size="6" title="Input atau Pilih Nomor" tabindex="3" autofocus required>
            ...
            function goodsReceiptItemRowElement(rowId, rowNumber, rowNumbers, item) {
                return `
                    <tr class="text-bold text-dark" id="${rowId}">
                        ...
                        <td>
                            <input type="text" class="form-control form-control-sm text-bold text-dark text-right readonly-input" name="received_quantity[]" id="receivedQuantity-${rowId}" tabindex="${rowNumbers + 2}" data-toogle="tooltip" data-placement="bottom" title="Hanya masukkan angka saja">
                        </td>
                        <td>
