...
@section('content')
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-0">
            <h1 class="h3 mb-0 text-gray-800 menu-title">Approval History - {{ getApprovalSubjectTypeLabel($approval->subject_label) }}</h1>
        </div>
        @if ($errors->any())
                        ...
                        <div class="card-body">
                            <div class="container so-update-container text-dark">
                                ...
                                <div class="row" style="margin-top: 5px;">
                                    ...
                                    @if(isApprovalSubjectTypeSalesReturn($approval->subject_label))
                                        <div class="col-12 col-lg-6">
