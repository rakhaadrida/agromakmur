                        ...
                        <div class="card-body">
                            <form action="{{ route('branches.update', $branch->id) }}" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <span class="col-form-label text-bold">:</span>
                                    <div class="col-3">
                                        <input type="text" class="form-control col-form-label-sm" name="phone_number" id="phoneNumber" value="{{ $branch->phone_number }}" data-toogle="tooltip" data-placement="bottom" title="Hanya masukkan angka saja" required>
                                    </div>
                                </div>
                                <div class="form-group row">
