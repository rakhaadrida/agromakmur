...
@section('content')
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-2">
            <h1 class="h3 mb-0 text-gray-800 menu-title">Daftar Unit</h1>
            <div class="justify-content-end">
                <a href="{{ route('units.create') }}" class="btn btn-sm btn-primary shadow-sm">
                    <i class="fas fa-plus fa-sm text-white-50 mr-1"></i>  Tambah Unit Baru
                </a>
                <span class="vertical-hr mr-2 ml-1"></span>
                <a href="{{ route('units.deleted') }}" class="btn btn-sm btn-outline-danger shadow-sm">
                    <i class="fas fa-trash-alt fa-sm text-dark-50 mr-1"></i>  Unit yang Dihapus
                </a>
            </div>
        </div>
        <div class="row">
...
@push('addon-script')
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.btn-delete', function () {
            ...
            const url = `{{ route('units.destroy', '') }}` + '/' + unitId;
