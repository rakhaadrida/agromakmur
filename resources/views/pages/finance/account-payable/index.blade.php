...
@section('content')
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-0">
            <h1 class="h3 mb-0 text-gray-800 menu-title">Daftar Hutang</h1>
        </div>
        @if ($errors->any())
                            ...
                            <form action="{{ route('account-payables.index') }}" method="GET" id="form">
                                <div class="container so-container">
                                    <div class="form-group row account-payable-filter-row">
                                        ...
                                        <label for="supplier" class="col-auto col-form-label text-bold text-right">Supplier</label>
                                        <span class="col-form-label text-bold">:</span>
                                        <div class="col-4 mt-1">
                                            <select class="selectpicker supplier-params-select-picker" name="supplier_id" id="supplier" data-live-search="true" data-size="6" title="Input atau Pilih Supplier" tabindex="3">
                                    ...
                                    <div class="form-group row account-payable-filter-row">
                                        ...
                                        <label for="finalDate" class="col-auto col-form-label text-bold text-center ml-1 filter-final-date-payable"> s / d </label>
                                        <div class="col-2">
                                        ...
                                        <div class="col-1 mt-1 ml-n3">
                                            <button type="submit" class="btn btn-success btn-sm btn-block text-bold" formaction="{{ route('account-payables.export') }}" formmethod="GET">Export</button>
                                        </div>
                                        <div class="col-1 mt-1 ml-n3">
                                            <button type="submit" class="btn btn-danger btn-sm btn-block text-bold" formaction="{{ route('account-payables.pdf') }}" formmethod="GET" formtarget="_blank">PDF</button>
                                        </div>
                                    </div>
                                </div>
                                <hr>
