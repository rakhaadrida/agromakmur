...
@section('content')
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-0">
            <h1 class="h3 mb-0 text-gray-800 menu-title">Cek Faktur</h1>
        </div>
        @if ($errors->any())
                            ...
                            <form action="" method="GET" id="form">
                                ...
                                <div class="container so-container">
                                    <div class="form-group row">
                                        ...
                                        <span class="col-form-label text-bold">:</span>
                                        <div class="col-4">
                                            <select class="selectpicker supplier-params-select-picker" name="customer_id" id="customer" data-live-search="true" title="Input atau Pilih Customer" tabindex="2">
                                            ...
                                            <div class="carousel-item @if(!$key) active @endif">
                                                <div class="container so-update-container text-dark">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group row">
                                                                <label for="orderNumber" class="col-2 form-control-sm text-bold text-right mt-1">Nomor SO</label>
                                                                <span class="col-form-label text-bold">:</span>
                                                                <div class="col-2">
