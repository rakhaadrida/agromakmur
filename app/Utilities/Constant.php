...
class Constant
{
    ...
    const SALES_ORDER_STATUSES = [
        self::SALES_ORDER_STATUS_ACTIVE,
        self::SALES_ORDER_STATUS_CANCELLED,
        self::SALES_ORDER_STATUS_UPDATED,
        self::SALES_ORDER_STATUS_WAITING_APPROVAL
    ];
    ...
    const SALES_ORDER_TYPES = [
        self::SALES_ORDER_TYPE_RETAIL,
        self::SALES_ORDER_TYPE_WHOLESALE,
    ];
