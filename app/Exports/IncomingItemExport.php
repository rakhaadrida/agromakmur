...
class IncomingItemExport extends DefaultValueBinder implements FromView, ShouldAutoSize, WithStyles
{
    use Exportable;
    ...
    {
        $receiptItems = $this->getIncomingItemsData();
        ...
        return view('pages.admin.report.incoming-item.export', $data);
    }
    ...
    protected function getIncomingItemsData()
    {
