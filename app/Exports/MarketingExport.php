...
class MarketingExport implements FromView, ShouldAutoSize, WithStyles
{
    use Exportable;

    public function view(): View
    {
        $marketings = Marketing::withTrashed()->where('is_destroy', 0)->get();
        ...
        return view('pages.admin.marketing.export', $data);
    }
