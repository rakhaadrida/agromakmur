...
class GoodsReceiptItemSheet extends DefaultValueBinder  implements FromView, ShouldAutoSize, WithStyles
{
    protected $request;
    ...
    {
        $goodsReceiptItems = $this->getReceiptItemData();
        ...
        return view('pages.admin.goods-receipt.export-detail', $data);
    }
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $range = 5 + $goodsReceiptItems->count();
    ...
    protected function getReceiptItemData() {
        $startDate = $this->request->start_date;
        $finalDate = $this->request->final_date;

        $baseQuery = GoodsReceiptService::getBaseQueryExportItem();
