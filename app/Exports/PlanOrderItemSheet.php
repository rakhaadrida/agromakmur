...
class PlanOrderItemSheet extends DefaultValueBinder  implements FromView, ShouldAutoSize, WithStyles
{
    protected $request;
    ...
    {
        $planOrderItems = $this->getPlanOrderItemData();
        ...
        return view('pages.admin.plan-order.export-detail', $data);
    }
    ...
    protected function getPlanOrderItemData() {
        $startDate = $this->request->start_date;
        $finalDate = $this->request->final_date;

        $baseQuery = PlanOrderService::getBaseQueryExportItem();
