...
class AccountReceivableSheet extends DefaultValueBinder  implements FromView, ShouldAutoSize, WithStyles, WithCustomValueBinder
{
    ...
    {
        $accountReceivables = $this->getReceivableData();
        ...
        return view('pages.finance.account-receivable.export-index', $data);
    }
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $range = 5 + $accountReceivables->count();
    ...
    protected function getReceivableData() {
        return AccountReceivableService::getExportIndexData($this->request);
    }
}
